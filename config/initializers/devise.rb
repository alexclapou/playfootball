...
Devise.setup do |config|
  ...
  config.omniauth :facebook, Rails.application.credentials.dig(:facebook, :app_id), Rails.application.credentials.dig(:facebook, :app_secret), token_params: { parse: :json }, info_fields: 'email, first_name, last_name'
